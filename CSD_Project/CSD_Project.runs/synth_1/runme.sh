...
HD_PWD='D:/Verilog files/CSD_Project/CSD_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Riscv_32_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Riscv_32_bit.tcl
